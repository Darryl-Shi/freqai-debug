...
from strategies.binance.utils.ClassifierDarts import ClassifierDarts
...
class NNPredictor_NHiTS(ClassifierDarts):
    ...
    def load_from_checkpoint(self):
        return NHiTSModel.load_from_checkpoint(
            self.model_name, work_dir=self.get_checkpoint_dir(), best=True
        )
